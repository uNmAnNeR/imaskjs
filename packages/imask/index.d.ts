...
declare namespace IMask {
  ...
  type MaskedPatternOptions = MaskedOptions<string> &
    Partial<Pick<MaskedPattern,
      'blocks' | 'definitions' | 'placeholderChar' | 'lazy'>>;
  type MaskedPatternOptionsDefaults = Pick<MaskedPattern,
  ...
  export class MaskedPattern extends Masked<string> {
    ...
    updateOptions(opts: Partial<MaskedPatternOptions>): void;
  ...
  } & Pick<MaskedPatternOptions,
    Exclude<keyof MaskedPatternOptions, 'mask'>> &
    Partial<Pick<MaskedDate,
  ...
  type DeduceMasked<Opts extends AnyMaskedOptions> = Opts extends MaskedPatternOptions
    ? MaskedPattern
